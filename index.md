...
- [[caching-strategies]] — read-through·TTL·eviction·일관성·SPOF 회피 (ch01, ch09, ch11, ch13, ch14)
...
- [[database-replication]] — master/slave 복제로 읽기 분산·가용성 (ch01, ch09, ch11, ch14)
...
- [[pre-signed-url]] — 클라이언트→스토리지 직접 업로드 인가(S3) (ch14)
...
- [[sharding]] — DB 수평 분할·sharding key·hotspot/resharding 문제 (ch01, ch09, ch11, ch13, ch14)
...
- [[stateless-web-tier]] — 세션 외부화로 sticky session 회피 (ch01, ch11, ch14)
...
- [[blob-storage]] — 대용량 비정형 객체 저장(S3), 영상·미디어 (storage, ch14)
...
- [[load-balancer]] — 트래픽 분산·failover의 정문 컴포넌트 (proxy, ch01, ch11, ch12, ch13, ch14)
- [[memcached]] — 분산 in-memory key-value 캐시 (cache, ch01)
- [[message-queue]] — 비동기 메시지 미들웨어 (queue, ch01, ch10, ch11, ch12, ch14)
